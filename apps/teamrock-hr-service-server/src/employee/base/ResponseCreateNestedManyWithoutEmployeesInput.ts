...
@InputType()
class ResponseCreateNestedManyWithoutEmployeesInput {
...
export { ResponseCreateNestedManyWithoutEmployeesInput as ResponseCreateNestedManyWithoutEmployeesInput };
