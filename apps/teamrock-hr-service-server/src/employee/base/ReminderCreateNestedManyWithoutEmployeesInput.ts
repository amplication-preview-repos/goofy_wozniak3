...
@InputType()
class ReminderCreateNestedManyWithoutEmployeesInput {
...
export { ReminderCreateNestedManyWithoutEmployeesInput as ReminderCreateNestedManyWithoutEmployeesInput };
